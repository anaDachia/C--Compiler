...
public class Program 
{
	...
	public static  String stPath = ""; //"E:/sharif/term6/compiler/project third phase/post.npt";
	
	public static String inputPath;// = "E:/sharif/term6/compiler/projectCode/Test Phase 2/Test Phase 2/my_test.l";
	public static String outputPath;// = "output.Lm";
	...
	PTBlock[][] parseTable = null;
        ...
        try
        {
    		...
    		try
    		{
    			...
    			stPath = Program.class.getProtectionDomain().getCodeSource().getLocation().toString();
    			stPath = stPath.replace('\\', '/');
    			stPath = stPath.substring(5);
    
    			
    			File f = new File(stPath);
    			String new_path = f.getParent();
    			
    
    			java.io.FileInputStream fis = new java.io.FileInputStream(new java.io.File(new_path + "/post.npt"));
